...
module Prawn::Document::Security
  FullPermissions = ::T.let(nil, ::T.untyped)
  PasswordPadding = ::T.let(nil, ::T.untyped)
  PermissionsBits = ::T.let(nil, ::T.untyped)
end
...
module RQRCode
  ...
  QRERRORCORRECTLEVEL = ::T.let(nil, ::T.untyped)
  QRFORMATINFOLENGTH = ::T.let(nil, ::T.untyped)
  QRMASKCOMPUTATIONS = ::T.let(nil, ::T.untyped)
  QRMASKPATTERN = ::T.let(nil, ::T.untyped)
  QRMAXDIGITS = ::T.let(nil, ::T.untyped)
  QRMODE = ::T.let(nil, ::T.untyped)
  QRMODE_NAME = ::T.let(nil, ::T.untyped)
  QRPOSITIONPATTERNLENGTH = ::T.let(nil, ::T.untyped)
end
...
class RQRCode::QRBitBuffer
  PAD0 = ::T.let(nil, ::T.untyped)
  PAD1 = ::T.let(nil, ::T.untyped)
end

class RQRCode::QRMath
  EXP_TABLE = ::T.let(nil, ::T.untyped)
  LOG_TABLE = ::T.let(nil, ::T.untyped)
end

class RQRCode::QRNumeric
  NUMBER_LENGTH = ::T.let(nil, ::T.untyped)
end

class RQRCode::QRRSBlock
  RS_BLOCK_TABLE = ::T.let(nil, ::T.untyped)
end

class RQRCode::QRUtil
  BITS_FOR_MODE = ::T.let(nil, ::T.untyped)
  DEMERIT_POINTS_1 = ::T.let(nil, ::T.untyped)
  DEMERIT_POINTS_2 = ::T.let(nil, ::T.untyped)
  DEMERIT_POINTS_3 = ::T.let(nil, ::T.untyped)
  DEMERIT_POINTS_4 = ::T.let(nil, ::T.untyped)
  G15 = ::T.let(nil, ::T.untyped)
  G15_MASK = ::T.let(nil, ::T.untyped)
  G18 = ::T.let(nil, ::T.untyped)
  PATTERN_POSITION_TABLE = ::T.let(nil, ::T.untyped)
end
...
module Sixword
  VERSION = ::T.let(nil, ::T.untyped)
  WORDS = ::T.let(nil, ::T.untyped)
  WORDS_HASH = ::T.let(nil, ::T.untyped)
end

module Sixword::Hex
  HexStrip = ::T.let(nil, ::T.untyped)
  HexValid = ::T.let(nil, ::T.untyped)
end
